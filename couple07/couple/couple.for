...
C
C YIQING: 
C GFORTRAN DOES NOT HAVE TIMER
C LET US CHAGNE TO CPU_TIME(START) AND CPU_TIME(FINISH) 
...
C
C YIQING:
C THERE IS SOMETHING REALLY STRANGE
C THE FOLLOWING LINES ONLY ALLOW INPUT FILE AS 'COUPLE.DAT'
